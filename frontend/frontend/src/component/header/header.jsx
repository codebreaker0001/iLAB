      ...
      <nav class="bg-white border-green-200 px-4 lg:px-6 py-2.5 dark:bg-white-500">
        <div class="flex flex-wrap justify-between items-center mx-auto w-screen  ">
          ...
          <div class="flex items-center lg:order-2">
            <a href="#" class="text-gray-800 dark:text-black hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 "><button onClick={handleClick}>GetAnotherLabReport</button></a>
